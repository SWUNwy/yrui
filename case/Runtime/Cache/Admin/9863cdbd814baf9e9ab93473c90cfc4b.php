...
<head>
    ...
    <link rel="stylesheet" href="/yrui/case/public/Admin/js/login/layui/css/layui.css">
    <link rel="stylesheet" href="/yrui/case/public/Admin/css/login/admin.css">
    <!--[if lt IE 9]>
    <script src="/yrui/case/public/Admin/js/login/html5shiv.min.js"></script>
    <script src="/yrui/case/public/Admin/js/login/respond.min.js"></script>
    <style>
...
<script src="/yrui/case/public/Admin/js/login/jquery.min.js"></script>
<script src="/yrui/case/public/Admin/js/login/layui/lay/dest/layui.all.js"></script>
<script src="/yrui/case/public/Admin/js/login/admin.js"></script>
<script src="/yrui/case/public/Admin/js/http/login/login.js"></script> -->
</body>
</html>